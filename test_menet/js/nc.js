!function (t) {
    ...
    , function (t, e, n) {
        ...
        function s(t) {
            ...
            return e.innerHTML = "\x3c!--[if IE " + t + "]><i></i><![endif]--\x3e",
                C[t] = 1 === e.getElementsByTagName("i").length
        }
        function o(t) {
        ...
        function f(t) {
            ...
            if ("object" == (void 0 === t ? "undefined" : v(t))) {
                ...
                if (t.sort) {
                    ...
                    for (e in t)
                        t.hasOwnProperty(e) && n.push('"' + e + '":' + i(t[e]));
                    n = "{" + n.join() + "}"
                }
                return n
            }
        ...
        function g(t) {
            ...
            a.parentNode.insertBefore(o, a),
                ...
                ,
                o.src = t.url + (-1 == t.url.indexOf("?") ? "?" : "&") + s,
                t.timeout && (n = setInterval(function () {
                    e++;
                    var a;
                    if (e >= t.times) {
                        b[i] = function () { }
                        ...
                        try {
                            o.parentNode && o.parentNode.removeChild(o),
                                ...
                                a = y.getElementsByTagName("script")[0],
                                a.parentNode.insertBefore(o, a),
                                o.src = t.url + (-1 == t.url.indexOf("?") ? "?" : "&") + s + "&t=" + Math.random()
                        } catch (t) { }
                }, t.timeout))
        }
        function h(t) {
            for (var e, n, i = [].slice.call(arguments), a = i.length, s = 1; s < a; s++) {
                e = i[s];
                for (n in e)
                    e.hasOwnProperty(n) && ("Flag" === n && t[n] ? t[n] = t[n] | e[n] : t[n] = e[n])
            }
            return t
        }
        function m(t) {
        ...
        function _(t, e, n) {
            ...
            for (var i = [], a = "*" === n && e.all ? e.all : e.getElementsByTagName(n), s = a.length; --s >= 0;)
                l(a[s], t) && i.push(a[s]);
            return i
        }
        function x(t, e, n) {
    ...
    , function (t, e, n) {
        ...
        function a(t) {
            l.jsonp({
                ...
                success: function (e) {
                    e.result && (e.result.result && (t.NVC_Result.nvcPreRes = e.result.result),
                        t.options.capCode = e.result.code,
                        400 === t.options.capCode ? t.getNC() : 600 === t.options.capCode && t.getSC())
                }
            })
        }
        function s(t) {
            ...
            if (t.apimap) {
                ...
                r.URL[e].analyze = t.apimap.analyze ? t.apimap.analyze : r.URL[e].analyze,
                    r.URL[e].initialize = t.apimap.initialize ? t.apimap.initialize : r.URL[e].initialize
            }
            if (t.language || (t.language = "cn"),
                !t.hasOwnProperty("default_txt") && t.hasOwnProperty("language") && o.hasOwnProperty(t.language) && (t.default_txt = o[t.language].default_txt),
                !t.hasOwnProperty("success_txt") && t.hasOwnProperty("language") && o.hasOwnProperty(t.language) && (t.success_txt = o[t.language].success_txt),
                !t.hasOwnProperty("fail_txt") && t.hasOwnProperty("language") && o.hasOwnProperty(t.language) && (t.fail_txt = o[t.language].fail_txt),
                !t.hasOwnProperty("neterr_txt") && t.hasOwnProperty("language") && o.hasOwnProperty(t.language) && (t.neterr_txt = o[t.language].neterr_txt),
                !t.hasOwnProperty("scaning_txt") && t.hasOwnProperty("language") && o.hasOwnProperty(t.language) && (t.scaning_txt = o[t.language].scaning_txt),
                t.test)
                t.appkey = "CF_APP_1",
                    t.scene = "nvc_register",
                    t.trans = t.trans || {},
                    t.trans.nvcCode = 200,
                    t.trans.key1 = "code0",
                    t.test === u.TEST_BLOCK ? (t.trans.nvcCode = 800,
                        t.trans.key1 = "code300") : t.test === u.TEST_NC_PASS ? (t.trans.nvcCode = 400,
                            t.trans.key1 = "code0") : t.test === u.TEST_NC_BLOCK ? (t.trans.nvcCode = 400,
                                t.trans.key1 = "code300") : t.test === u.TEST_SC_PASS ? (t.trans.nvcCode = 600,
                                    t.trans.key1 = "code0") : t.test === u.TEST_SC_BLOCK && (t.trans.nvcCode = 600,
                                        t.trans.key1 = "code300");
        ...
        i.prototype = {
            constructor: function (t) {
                this.options = l.mix({}, r.ic.default_options, t),
            ...
            getNVCVal: function () {
                ...
                var e = t.NVC_Data;
                return e.b = t.__fy && t.__fy.getFYToken && t.__fy.getFYToken(t.__fy_options),
                    e.h.umidToken = t.__fy && t.__fy.getFYToken && t.__fy.getUidToken(),
                    t.NVC_Result.nvcPreRes && (e.e = t.NVC_Result.nvcPreRes.c),
                    t.NVC_Result.sessionId && (e.f = t.NVC_Result.sessionId),
                    t.NVC_Result.sig && (e.g = t.NVC_Result.sig),
            ...
            getNVCValAsync: function (t) {
                ...
                var n = +new Date
                    , i = setInterval(function () {
                        var a = e.NVC_Data;
                        a.b = e.__fy && e.__fy.getFYToken && e.__fy.getFYToken(e.__fy_options),
                            a.h.umidToken = e.__fy && e.__fy.getFYToken && e.__fy.getUidToken(),
                            (a.b || +new Date - n > 1e3) && (clearInterval(i),
                                e.NVC_Result.nvcPreRes && (a.e = e.NVC_Result.nvcPreRes.c),
                                e.NVC_Result.sessionId && (a.f = e.NVC_Result.sessionId),
                                e.NVC_Result.sig && (a.g = e.NVC_Result.sig),
                                t && t(encodeURIComponent(JSON.stringify(a))))
                    }, 100)
            },
            getNC: function (t) {
                var e = this;
                t = t || {};
                var n = +new Date;
                e.options.popUp && popup.insertDom(1, e.options, n),
                    AWSC.use("nc", function (i, a) {
                        t.appkey = e.options.appkey,
                            t.scene = e.options.scene,
                            t.nvcToken = e.options.token,
                            t.trans = e.options.trans,
                            t.renderTo = e.options.renderTo,
                            e.options.fontSize && (t.fontSize = e.options.fontSize),
                            e.options.foreign && (t.foreign = e.options.foreign),
                            e.options.language && (t.language = e.options.language),
                            !t.customWidth && e.options.popUp && (t.width = 300),
                            t.success = function (t) {
                                e.NVC_Result.sessionId = t.sessionId,
                                    e.NVC_Result.sig = t.sig,
                                    e.options.popUp && popup.hideDom(1, n),
                                    setTimeout(function () {
            ...
            getSC: function () {
                var t = this
                    , e = +new Date;
                t.options.popUp && popup.insertDom(2, t.NVC_Opt, e),
                    t.SC_Opt = {
                        elementID: [],
                        is_Opt: "",
                        type: "scrape",
                    ...
                    AWSC.use("nc", function (n, i) {
                        ...
                        a.callback = function (n) {
                            t.NVC_Result.sessionId = n.sessionId,
                                t.NVC_Result.sig = n.sig,
                                t.options.popUp && popup.hideDom(2, e),
                                t.options.nvcCallback && t.options.nvcCallback(t.getNVCVal())
                        }
                            ,
                            t.sc = i.init(a)
                    })
            ...
            query: function () {
                ...
                l.removeClass(e, "sm-btn-default"),
                    l.removeClass(e, "sm-btn-fail"),
                    l.addClass(e, "sm-btn-loading");
                var n = this
                        ...
                        success: function (t) {
                            if (t.success) {
                                switch (t.result.code) {
                                    case 100:
                                    case 200:
                                        t.result.result.token = n.options.token,
            ...
            popNC: function (t) {
                ...
                t) {
                    ...
                    case "nc":
                        p(n, "backgroundColor", ""),
                            "sc" === t ? (i = (r.ic.sc_height > this.height ? r.ic.sc_height : this.height) + 20,
            ...
            succeed: function (t) {
                var e = document.getElementById(this.id);
                this.successful = !0,
                    l.removeClass(e, "sm-btn-loading"),
                    l.removeClass(e, "sm-btn-fail"),
                    l.addClass(e, "sm-btn-success"),
    ...
    , function (t, e, n) {
        ...
        function a() {
            ...
            if (!c.isIEX(8) && !c.isIEX(9))
                for (var e = 1; e < 13; e++)
                    t += '<div class="sk-circle' + e + ' sk-circle"></div>';
            return t += "</div>"
        }
        // 滑块开始
        function s(t) {
            function e() {
                ...
                o.nc_wrapper.innerHTML = '<div id="nc_' + o.wrapperId + '__n1t_loading" class="nc_scale"><div id="nc_' + o.wrapperId + '__bg" class="nc_bg" style="width: 0px;"></div><div id="nc_' + o.wrapperId + '__scale_text_loading" class="scale_text"><span class="nc-lang-cnt"><b>' + l.getLanuage(t, "LOADING") + "</b></span>" + a() + "</div>",
                    d.loadFY(o, function (t) {
                        e()
                    }, function (e) {
                        c.getNCPunish(t, "fyLoad", e),
                            i(h)
                    })
            }
            function n() {
                ...
                function e(e) {
                    ...
                    function i() {
                        ...
                        var e = {};
                        e.btn = k,
                            e.bar = w.childNodes[1],
                            C.className += " nc-align-center scale_text2",
                            C.innerHTML = '<span class="nc-lang-cnt" ><b>' + l.getLanuage(t, "LOADING") + "</b></span>" + a(),
                            m()
                    }
                    function s(t) {
                        // 栈顶
                        ...
                        if (k.style.left = a + "px",
                            n(Math.round(100 * Math.max(0, a / v)), a),
                            e >= S + w.offsetWidth && (a < v || e - y < v))
                            return void d.call(this);
                        var s = c.getClientRect(k).left;
                        a !== v && e - s - x !== v || i()
                    }
                    function d() {
                        parseInt(k.style.left) < v && (c.addClass(k, "button_move"),
                    ...
                    function g(t) {
                        t.preventDefault(),
                            s.call(this, t.touches[0])
                    }
                    // 计算滑块坐标
                    o.__fy.fyObj.startRecord();
                    // k 是 span 标签：<span id="nc_1_n1z" class="nc_iconfont btn_slide" style="left: 0px;"></span>
                    // w 是 div 标签：整个滑块区域
                    var h = !1
                        , _ = (e || u.event).clientX
                        , x = k.offsetWidth // 48
                        , v = w.offsetWidth - x // 252
                        , y = k.offsetLeft  // 0
                        , S = c.getClientRect(w).left;  // 810.3666381835938
                ...
                function m() {
                    // 生成轨迹数据的主要方法:  o.__fy.getFYToken
                    // 栈顶3
                    function e() {
                        // 选择 url
                        s++,
                            a.n = o.__fy.getFYToken(o.__fy_options),    // 轨迹数据由 __fy_options 生成
                            (-1 == a.n.indexOf("default") || s > 50) && (setTimeout(function () {
                                if (-1 != a.n.indexOf("default") && t.reportUrl && c.getNCPunish(t, "fyDefault", a.n),
                                    t.noRequest)
                                    _(a);
                                else {
                                    var e = {
                ...
                function _(e) {
                    k.className = "nc_iconfont btn_ok",
                        k.innerHTML = "&#xe60b;",
                        C.innerHTML = '<span class="nc-lang-cnt" data-nc-lang="SLIDE"><b>' + l.getLanuage(t, "SUCCESS") + "</b></span>",
                        t.success && t.success(e)
                }
                function x(e) {
                    if (e.success) {
                        if (0 === e.result.code) {
                            ...
                            var a = function (t, e, n) {
                                for (var i = 0, a = e, s = t.length; a < s;)
                                    i <<= 3,
                                        i += t.charCodeAt(a),
                                        a += n;
                                i < 0 && (i = 0 - i);
                ...
                C.id = "nc_" + o.wrapperId + "__scale_text",
                    ...
                    C.innerHTML = '<span class="nc-lang-cnt" data-nc-lang="SLIDE">' + l.getLanuage(t, "SLIDE") + "</span>",
                    v.appendChild(C),
            ...
            function i(e) {
                o.nc_wrapper.innerHTML = "<div id = `nc_" + o.wrapperId + '_refresh1` class="errloading"><i id = `nc_' + o.wrapperId + '_refresh2` class="nc_iconfont icon_warn">&#xe60a;</i><span class="nc-lang-cnt" data-nc-lang="SLIDE">' + l.getLanuage(t, "ERROR") + "</span>" + (t.hideErrorCode ? "" : '<span class="nc-errcode">(' + e + ")</span>") + "</div>",
                    c.addHandler(o.nc_wrapper, "mousedown", function t() {
                        c.removeEvt(o.nc_wrapper, "mousedown", t),
                            o.reset()
                    }),
                    c.addHandler(o.nc_wrapper, "touchend", function t() {
                        c.removeEvt(o.nc_wrapper, "touchend", t),
                            o.reset()
                    }),
                    t.error && t.error(e)
            }
            function s(e) {
                o.nc_wrapper.innerHTML = "<div id = `nc_" + o.wrapperId + '_refresh1` class="errloading"><i id = `nc_' + o.wrapperId + '_refresh2` class="nc_iconfont icon_warn">&#xe60a;</i>' + l.getLanuage(t, "FAIL") + (t.hideErrorCode ? "" : "(error:" + e + ")") + "</div>",
                    c.addHandler(o.nc_wrapper, "mousedown", function t() {
                        c.removeEvt(o.nc_wrapper, "mousedown", t),
                            o.reset()
                    }),
            ...
            o.options = t,
                ...
                function (e) {
                    ...
                    i.className = "nc_" + o.wrapperId + "_nocaptcha",
                        ...
                        n.appendChild(i),
                        c.insertCSS(".nc-container #nc_" + o.wrapperId + "_wrapper{width:" + ("auto" === t.width ? "auto" : t.width + "px") + ";height:" + t.height + "px;font-size:" + t.fontSize + "px;line-height:" + t.height + "px;}.nc-container .nc_" + o.wrapperId + "_n1z{width:" + (t.height / 34 * 42 | 0) + "px;}");
        ...
        function o(t) {
            if (t.apimap) {
                var e = t.foreign ? "us" : "cn";
                p.URL[e].analyze = t.apimap.analyze ? t.apimap.analyze : p.URL[e].analyze,
                    p.URL[e].initialize = t.apimap.initialize ? t.apimap.initialize : p.URL[e].initialize
            }
            if (t.test)
                t.appkey = "CF_APP_1",
                    t.scene = "register",
                    t.trans = t.trans || {},
                    t.trans.key1 = m.TEST_PASS,
                    t.test === m.TEST_BLOCK && (t.trans.key1 = m.TEST_BLOCK);
            else if ("string" != typeof t.appkey || "string" != typeof t.scene) {
                var n = window.console;
                n && n.error("Invalid NC params: appkey=" + t.appkey + " scene=" + t.scene)
            }
            if ("auto" !== t.width && (t.width = t.width > 300 ? t.width : 300),
                34 !== t.height && (t.height = t.height > 34 ? t.height : 34),
                t.fontSize ? t.fontSize = t.fontSize > 12 ? t.fontSize : 12 : t.fontSize = t.height / 34 * 12 | 0,
                t.timeout = t.timeout || 3e3,
                t.language = t.language || "cn",
                t.times = t.times || 5,
                t.hideErrorCode = !!t.hideErrorCode,
                t.token || (t.token = t.nvcToken || [t.appkey, t.scene, +new Date, Math.random()].join(":")),
                !t.replaceCallback && "function" != typeof t.success) {
                var n = u.console;
        ...
        function r(t) {
            function e() {
                ...
                a && u.MutationObserver && (c.getNCPunish(t, "initSuccess", s),
                    i.disconnect()),
                    !u.MutationObserver && a && c.getNCPunish(t, "initSuccess", s),
                    a || u.MutationObserver || setTimeout(e, 2e3)
            }
            var n;
            try {
                ...
                n = void 0,
                    c.getNCPunish(t, "initDomError", "targetNode is undefined")
            }
            if (c.getNCPunish(t, "stratInit", "init"),
                u.MutationObserver && n) {
    ...
    , function (t, e, n) {
        ...
        function s(t) {
            ...
            if (t.test)
                t.appkey = "CF_APP_1",
                    ...
                    t.trans.nvcCode = 200,
                    t.trans.key1 = "code0",
                    t.test === d.TEST_BLOCK ? (t.trans.nvcCode = 800,
                        t.trans.key1 = "code300") : t.test === d.TEST_NC_PASS ? (t.trans.nvcCode = 400,
                            t.trans.key1 = "code0") : t.test === d.TEST_NC_BLOCK ? (t.trans.nvcCode = 400,
                                t.trans.key1 = "code300") : t.test === d.TEST_SC_PASS ? (t.trans.nvcCode = 600,
                                    t.trans.key1 = "code0") : t.test === d.TEST_SC_BLOCK && (t.trans.nvcCode = 600,
                                        t.trans.key1 = "code300");
            else if ("string" != typeof t.appkey || "string" != typeof t.scene) {
                var n = window.console;
                n && n.error("Invalid NVC params: appkey=" + t.appkey + " scene=" + t.scene)
        ...
        i.prototype = {
            ...
            getNC: function (t) {
                if (t = t || {},
                    t.appkey || t.scene || t.test) {
                    var e = window.console;
                    e && e.error("\u5728\u4e8c\u6b21\u9a8c\u8bc1\u4e2d\uff0c\u8bf7\u4e0d\u8981\u914d\u7f6e\u521d\u59cb\u5316\u53c2\u6570appkey\uff0cscene\uff0ctest\u7684\u503c")
                }
                var n = this;
                AWSC.use("nc", function (e, i) {
                    t.appkey = n.options.appkey,
                        t.scene = n.options.scene,
                        t.nvcToken = n.options.token,
                        t.trans = n.options.trans,
                        t.success = function (t) {
                            n.NVC_Result.sessionId = t.sessionId,
                                n.NVC_Result.sig = t.sig,
            ...
            getSC: function () {
                ...
                t.SC_Opt = {
                    ...
                    AWSC.use("nc", function (e, n) {
                        ...
                        i.nvcToken = t.options.token,
                            i.test = void 0,
                            i.success = function (e) {
                                t.NVC_Result.sessionId = e.sessionId,
                                    t.NVC_Result.sig = e.sig,
                                    t.options.success && t.options.success(t.getNVCVal())
                            }
                            ,
                            i.fail = function (e) {
            ...
            reset: function () {
                var t = this;
                t.NVC_Data && t.NVC_Data.f && (t.NVC_Data.f = null),
                    t.NVC_Data && t.NVC_Data.g && (t.NVC_Data.g = null),
                    t.NVC_Result && t.NVC_Result.sessionId && (t.NVC_Result.sessionId = null),
                    t.NVC_Result && t.NVC_Result.sig && (t.NVC_Result.sig = null),
                    t.nc && t.nc.reset()
            }
        };
        var d = {
