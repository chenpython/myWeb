!function (e, t) {
    ...
    var n = 1e4, g_moduleConfig = {
        ...
        fyModule: {
            ...
            stable: ["AWSC/fireyejs/1.224.1/fireyejs.js"],
            greyBr: ["AWSC-br/fireyejs/1.225.0/fireyejs.js"],
            stableBr: ["AWSC-br/fireyejs/1.224.1/fireyejs.js"],
            ratio: 9999,
            greyConfig: {
            },
            stableConfig: {
        ...
        umidPCModule: {
            ...
            grey: ["AWSC/WebUMID/1.92.0/um.js"],
            stable: ["AWSC/WebUMID/1.92.0/um.js"],
            greyBr: ["AWSC-br/WebUMID/1.92.0/um.js"],
            stableBr: ["AWSC-br/WebUMID/1.92.0/um.js"],
            ratio: 10000,
            greyConfig: {
            },
            stableConfig: {
                    ...
                    "etModule" === t && (i ? (d.normalAddresses.pop(),
                        d.brAddresses.pop()) : r ? (d.normalAddresses.pop(),
                            d.brAddresses.pop()) : s || l || c ? (d.normalAddresses.shift(),
                                d.brAddresses.shift()) : u() ? (d.normalAddresses.pop(), d.brAddresses.pop()) : (d.normalAddresses.shift(),
                                    d.brAddresses.shift()));

                for (var g = 0;
                    g < d.normalAddresses.length;
                    g++) {
    ...
    function C() {
        ...
        for (var e = document.getElementsByTagName("script"), t = 0;
            t < e.length;
            t++) {
    ...
    function T(t, n, o) {
        ...
        var a = "https://acjs.aliyun.com/error?v=" + t + "&e=" + encodeURIComponent(n) + "&stack=" + encodeURIComponent(o), r = new Image, i = "_awsc_img_" + Math.floor(1e6 * Math.random());
    ...
    function k(e, t, n, o) {
        ...
        if (0 !== a.depends.length) for (var l = 0;
            l < a.depends.length;
            l++) {
        ...
        u.module = a, u.name = e, u.state = m, u.callbacks = u.callbacks || [],
            u.options = n,
    ...
    function M(e, t, n) {
        ...
        try {
            ...
            }, r.module = a, r.name = t, r.state = b, r.exportObj = n, r.callbacks = [], f.push(r))
        } catch (l) {
            if (o) throw l;
        ...
        var t = g_moduleConfig.etModule, o = Math.ceil(Math.random() * n) <= t.ratio, a = o ? t.greyConfig.whitelist : t.stableConfig.whitelist, r = new RegExp(("^" + a.join("$|^") + "$").replace(/\*/g, ".*"));
        r.test(location.host + location.pathname) && (window.etrprtrt = .01, e.AWSC.use("et"))
    } function x(e) {
        e.AWSC || (e.AWSC = {
        }, e.AWSC.use = M, e.AWSCInner = {
        }, e.AWSCInner.register = B, U(e), D(e), E(e))
    } x(e)
}(window, document);
