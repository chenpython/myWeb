...
, function(e, t, n) {
    ...
    function s(e) {
        ...
        C[e] = 1 === t.getElementsByTagName("i").length
    }
    function o(e) {
...
, function(e, t, n) {
    ...
    function s(e) {
        ...
        function s(t, n) {
            o.nc_wrapper.innerHTML = "<div id = `nc_" + o.wrapperId + '_refresh1` class="errloading"><i id = `nc_' + o.wrapperId + '_refresh2` class="nc_iconfont icon_warn">&#xe60a;</i>' + l.getLanuage(e, n ? "BXMARK" : "FAIL") + (e.hideErrorCode ? "" : "(error:" + t + ")") + "</div>",
            c.addHandler(o.nc_wrapper, "mousedown", function e() {
                c.removeEvt(o.nc_wrapper, "mousedown", e),
                o.reset()
            }),
    ...
    function r(e) {
        ...
        if (c.getNCPunish(e, "stratInit", "init"),
